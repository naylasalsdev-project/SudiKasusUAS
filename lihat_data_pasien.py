...
"}")
        ...
        self.label_3.setGeometry(QtCore.QRect(430, 30, 161, 51))
        font = QtGui.QFont()
...
"   padding: 6px;}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Data Pasien"))
    ...
    def cari_pasien(self):
        ...
        if id_pasien:
                data = Pasien.get_pasien_by_id(id_pasien)
        else:
                data = Pasien.get_all_pasien()

...
# Form implementation generated from reading ui file 'lihat_data_kasir.ui'
#
...
"}")
        ...
        self.label_3.setGeometry(QtCore.QRect(440, 30, 161, 51))
        font = QtGui.QFont()
...
"   padding: 6px;}")
        ...
        self.pushButton.clicked.connect(self.cari_kasir)
        self.pushButton_5.clicked.connect(self.kembali)

        self.tampil_semua_kasir()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Data Kasir"))
    ...
    def load_data(self, data):
        ...
        self.tableWidget.setHorizontalHeaderLabels(
            ["ID Kasir", "Nama", "Umur", "Username", "Password"]
        )
    ...
    def cari_kasir(self):
        id_kasir = self.lineEdit.text()

        if id_kasir:
                data = Kasir.get_kasir_by_id(id_kasir)
        else:
                data = Kasir.get_all_kasir()

        if data:
                self.load_data([data])
        else:
                QtWidgets.QMessageBox.information(
                None, "Info", "Data kasir tidak ditemukan"
                )

    def tampil_semua_kasir(self):
        data = Kasir.get_all_kasir()
        self.load_data(data)

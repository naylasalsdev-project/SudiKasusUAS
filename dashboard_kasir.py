...
"}")
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(280, 350, 81, 41))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.pushButton_2.clicked.connect(self.open_transaksi)
        self.pushButton_3.clicked.connect(self.open_riwayat_transaksi)

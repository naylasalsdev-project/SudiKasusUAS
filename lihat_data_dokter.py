...
"}")
        ...
        self.label_3.setGeometry(QtCore.QRect(430, 30, 171, 51))
        font = QtGui.QFont()
...
"   padding: 6px;}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Data Dokter"))
    ...
    def load_data(self, data):
        ...
        for row_number, row_data in enumerate(data):
            ...
            for column_number, item in enumerate(row_data):
                ...
                # rata tengah untuk ID & Umur (konsisten dengan admin)
    ...
    def cari_dokter(self):
        ...
        if id_dokter:
            data = Dokter.get_by_id(id_dokter)
        else:
            data = Dokter.get_all()

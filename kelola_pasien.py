...
import form_insert_data_pasien as fidp
...
"}")
        ...
        self.pushButton_2.clicked.connect(self.insert_data_pasien)
        self.pushButton_3.clicked.connect(self.edit_data_pasien)
        self.pushButton_4.clicked.connect(self.delete_data_pasien)
    ...
    def insert_data_pasien(self):
        self.window = QtWidgets.QMainWindow()
        self.ui = fidp.Ui_MainWindow()
        self.ui.setupUi(self.window)
        self.window.show()

    def edit_data_pasien(self):
        self.window = QtWidgets.QMainWindow()
        self.ui = fep.Ui_MainWindow()
        self.ui.setupUi(self.window)
        self.window.show()

    def delete_data_pasien(self):
        self.window = QtWidgets.QMainWindow()

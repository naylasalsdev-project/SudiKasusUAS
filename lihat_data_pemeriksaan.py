...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(648, 569)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(240, 180, 191, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
...
"")
        ...
        self.label_2.setGeometry(QtCore.QRect(140, 190, 91, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(450, 180, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label.setGeometry(QtCore.QRect(210, 90, 251, 61))
        font = QtGui.QFont()
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Lihat Data Pemeriksaan"))
    ...
    def load_data(self, data):
        ...
        self.tableWidget.setHorizontalHeaderLabels(["ID Pemeriksaan", "ID Dokter", "ID Perawat", "ID Pasien", "Tgl Pemeriksaan"])
    ...
    def cari_pemeriksaan(self):
        ...
        query = "SELECT * FROM pemeriksaan WHERE id_pemeriksaan = %s"
